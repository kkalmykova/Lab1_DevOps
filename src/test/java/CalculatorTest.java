...
public class CalculatorTest {
    ...
    public void testCalculate_Addition() {
        ...
        assertEquals(3.5, result, 0.0001); // Delta included for comparing floating-point numbers
    }
    ...
    public void testCalculate_Subtraction() {
        ...
        assertEquals(6.5, result, 0.0001); // Delta included for comparing floating-point numbers
    }
    ...
    public void testCalculate_Multiplication() {
        ...
        assertEquals(5.4, result, 0.0001); // Delta included for comparing floating-point numbers
    }
    ...
    public void testCalculate_Division() {
        ...
        assertEquals(9.0, result, 0.0001); // Delta included for comparing floating-point numbers
    }
